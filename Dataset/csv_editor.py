...
with open(input_file, 'r') as f_input, open(output_file, 'w', newline='') as f_output:
    ...
    f_input.seek(0)  # move the file cursor to the beginning of the file
    total = sum(1 for row in csv_input)  # count the number of rows in the file
    f_input.seek(0)  # move the file cursor back to the beginning of the file
