...
with open(input_file, 'r') as f_input, open(output_file, 'w', newline='') as f_output:
    ...
    f_input.seek(0)
    for row in tqdm(csv_input, total=total, unit="rows"):
        ...
        try:
            ...
            print("Row Has Correct Format:", row, "Current : Total", row+1,":", total, "\n")
            continue
        ...
        print("Successfully Formatted Row:", row, "Current : Total", row+1,":", total, "\n")
    print("Success!")